...
var dy: number = 5;
var dx: number = 5;
var holdSpace: boolean;
var gameOver: boolean = false;
var Score: number = 0;
var bulletCounter: number = 0;
var shotsPerHit: number = 0;
var resSum: number = canvas.height;
var resDividedbySpeed = canvas.height / dy;
var resFix: number = 0;
var Collision: boolean = false;
var numOfEnemies: number = 5;
var menuGone: boolean = false;
var preferenceMenu: boolean = false;
...
var rocketStopTop: number = canvas.height - (canvas.height - 110);
var rocketStopBottom: number = canvas.height - 60 - resFix;
